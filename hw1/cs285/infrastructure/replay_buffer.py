...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        rand_indices = np.random.permutation(self.obs.shape[0])
        select_indices = rand_indices[:batch_size]
        return self.obs[select_indices], self.acs[select_indices], self.rews[select_indices], self.next_obs[select_indices], self.terminals[select_indices]
